...
// ─── POST /api/leaves/apply-od  (DEPRECATED — use /api/od/apply) ─────────────
// Kept as a stub so existing callers get a clear redirect message
const applyOnDuty = async (req, res) => res.status(410).json({
  status: false,
  message: 'This endpoint has moved. Please use POST /api/od/apply',
});

// ─── PATCH /api/leaves/:id/od-status (DEPRECATED) ────────────────────────────
const approveOnDuty = async (req, res) => res.status(410).json({
  status: false,
  message: 'This endpoint has moved. Please use PATCH /api/od/:id/status',
});

// ─── GET /api/leaves/od/my (DEPRECATED) ──────────────────────────────────────
const getMyOnDutyRequests = async (req, res) => res.status(410).json({
  status: false,
  message: 'This endpoint has moved. Please use GET /api/od/my',
});

// ─── GET /api/leaves/od/:id (DEPRECATED) ─────────────────────────────────────
const getOnDutyById = async (req, res) => res.status(410).json({
  status: false,
  message: 'This endpoint has moved. Please use GET /api/od/:id',
});

// ─── POST /api/leaves/apply-regularization (DEPRECATED) ──────────────────────
const applyRegularization = async (req, res) => res.status(410).json({
  status: false,
  message: 'This endpoint has moved. Please use POST /api/regularization/apply',
});

// ─── PATCH /api/leaves/:id/regularize-status (DEPRECATED) ────────────────────
const approveRegularization = async (req, res) => res.status(410).json({
  status: false,
  message: 'This endpoint has moved. Please use PATCH /api/regularization/:id/status',
});

// ─── GET /api/leaves/regularization/my (DEPRECATED) ─────────────────────────
const getMyRegularizationRequests = async (req, res) => res.status(410).json({
  status: false,
  message: 'This endpoint has moved. Please use GET /api/regularization/my',
});
